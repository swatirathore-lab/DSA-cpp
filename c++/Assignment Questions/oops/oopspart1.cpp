...
int main ()
{
    ...
    u1.display();
    user1 u2(301);//practice question: In this code, we have a class called user1 that has a constructor which takes an integer parameter to initialize the id of the user. The class also has a setter function to set the password and a getter function to retrieve the username. In the main function, we create an object of the user1 class called u2 and pass the value 301 to the constructor to initialize the id. We then call the setter function to set the password for u2 and finally, we call the getter function to retrieve and display the username of u2.
    u2.setter("mypassword");
